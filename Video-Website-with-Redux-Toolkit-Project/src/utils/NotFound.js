                ...
                <div className="rounded relative">
                    <div>
                        <div className="flex justify-center items-center bg-white py-12">
                            <div>
                                <p className="text-black font-semibold text-3xl text-center tracking-wide">NO ITEM F
                                </p>
                            </div>
                            <div className="rounded-full bg-indigo-100 w-[30px] h-[30px] relative flex justify-center items-center animate-spin">
                                <svg
                                    className="absolute"
                                    width={ 30 }
                                    height={ 30 }
                            ...
                            <div>
                                <p className="text-black font-semibold text-4xl text-center tracking-wide">
                                    UND😥
                                </p>
                            </div>
                        </div>
